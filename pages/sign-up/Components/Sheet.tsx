...
export const Sheet = ({
  ...
  return (
    ...
    >
      ...
      {/* 개인정보수집및활용동의 */}
      <span className="pt-4 font-extrabold text-gray-9">{term?.title}</span>
      {/* 본문 */}
      <div className="bg-gray-1 max-h-[calc(80%-1rem)] flex-grow mt-4 p-4 font-extrabold rounded-xl overflow-y-scroll hide-scrollbar">
        {term?.content}
      </div>
    </motion.div>
  );
